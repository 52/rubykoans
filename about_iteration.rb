...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Answer: Save the returned value from each iteration to the first variable of the block to use for the next iteration.
    # Initial value is provided as an agrument of inject method
  end
