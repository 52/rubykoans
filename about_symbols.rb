...
class AboutSymbols < Neo::Koan
  ...
  #
  # Answer: Because if do so, Ruby will create a new symbol (which is the argument)
  ...
  #
  # Symbols stay in the memory until the program ends. Create a lot of
  # unused symbols will create a memory hog
end
